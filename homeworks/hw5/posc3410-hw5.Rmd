...
[^codebook]: https://github.com/svmiller/wvs-usa-abortion-attitudes/blob/master/README.md
...
5. Run Model 3 `(M3)` and plot the interactive relationship of age on attitudes toward abortion. What do you see?
