...
{% for lectures in site.data.lectures %}
      <li class="archiveposturl">
        <span><a href="{{ site.url }}/{{ lectures.dirname }}/posc3410-lecture-{{ lectures.filename }}.pdf">{{ lectures.title }}</a></span><br>
...
<a href="https://github.com/{{ site.githubdir}}/tree/master/{{ lectures.dirname }}/posc3410-lecture-{{ lectures.filename}}.Rmd"><i class="fab fa-r-project"></i></a>&nbsp;&nbsp;
<a href="https://github.com/{{ site.githubdir}}/blob/master/{{ lectures.dirname }}/posc3410-lecture-{{ lectures.filename}}.pdf"><i class="fas fa-file-pdf"></i></a>
</strong> 
      </li>
{% endfor %}
</ul>
